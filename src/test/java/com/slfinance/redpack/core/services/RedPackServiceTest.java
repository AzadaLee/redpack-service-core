...
public class RedPackServiceTest extends CreditServiceCoreApplicationTests {
	...
	@Test
	public void testRedPackDistributeJob(){
	...
	@Test
	public void testReturnCustomerNotRobRedpackMoneyJob(){
		redpackService.returnCustomerNotRobRedpackMoneyJob();
	}
	
	@Test
	public void testAuditRedPackById(){
		redpackService.auditRedPackById("ff808081588ba1ed01588bbc77960030", "审核通过", "1111");
	}
}
