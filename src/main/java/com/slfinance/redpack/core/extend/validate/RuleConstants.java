...
public class RuleConstants {
	 ...
	 * 手机正则表达式
	 */
	public static final Pattern PATTERN_MOBILE = Pattern.compile("(^1(3[0-9]|4[57]|5[0-35-9]|8[0-35-9]|7[78])\\d{8}$)|(^170[089]\\d{7}$)");
	/**
	 * 电话正则表达式
	 * <p>
	 * 首先验证不带区号<br />
	 ...
	 */
	public static final String DATE_FORMAT_TIME_BAR = "yyyy-MM-dd HH:mm:ss";
	/**
	 * 日期格式yyyy/MM/dd
	 */
	public static final String DATE_FORMAT_DAY_BACKSLASH = "yyyy/MM/dd";
	
	/**
	 * app版本号格式检测(*.*.*)
	 */
	public static final Pattern APPVERSION_FORMAT = Pattern.compile("\\d+(\\.\\d+){2}");
}
