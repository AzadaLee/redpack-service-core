...
public class RulesCache {
	...
	public static Rules getAnnotationRulesByMethod(Method method) {
		Rules rules = null;
		if (method != null && method.getAnnotation(Rules.class) != null) {
	 ...
	 * @return
	 */
	public static <T extends Annotation> T getAnnotationRules(String className, String methodName, Class<T> annotationClazz) {
		T t1 = null;
