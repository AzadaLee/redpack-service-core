...
public class RedPackConstant {
	...
	//交易密码规则：6位数字
	public static final Pattern TRANSACTION_PASSWORD_REGEX = Pattern.compile("\\d{6}");
	...
	/**
	 *红包的创建在前一天15点之前完成 ,红包发送时间必须在第二天凌晨前9个小时完成
	 */
	public static final Integer REDPACK_SAVE_BEFORE_HOURS = 9;
	...
	/**
	 * 抢红包固定时间点,注意顺序一定是从小到大排序
	 */
	public static String[] REDPACK_TIME_POINT = {" 09:00:00"," 10:00:00"," 11:00:00"," 14:00:00"," 15:00:00"," 16:00:00"," 20:00:00"," 21:00:00"};
