...
package com.slfinance.redpack.core.extend.validate.annotations;
...
public @interface Rule {
	 ...
	 * 校验appVersion是否符合规范(*.*.*)
	 * @author taoxm
	 * @createTime 2016年8月25日 下午5:31:52
	 * @return
	 */
	boolean appVersion() default false;
	
	String appVersionMessage() default "app版本格式不正确";
