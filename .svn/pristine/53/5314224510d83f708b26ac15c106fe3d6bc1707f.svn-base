...
public interface AdvertisementRepository extends BaseRepository<Advertisement> {
	 ...
	 * @return
	 */
	Advertisement findFirstByTypeAndStartDateLessThanEqualAndEndDateGreaterThanEqualAndStatusAndRecordTypeOrderByStartDateDesc(AdvertisementType type, Date startDate, Date endDate, AdvertisementStatus status,RecordType recordType);
